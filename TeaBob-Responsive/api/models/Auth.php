<?php
	class Auth {
		...
		public function regUser($dt){
            ...
            $sql = "INSERT INTO tbl_user( user_name, user_uname,user_contact,user_address, user_pword) 
                           VALUES ('$dt->user_name','$dt->user_uname','$dt->user_contact','$dt->user_address', '$encryptedPassword')";
